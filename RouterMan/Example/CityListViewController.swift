...
class CityListViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    let items = [
        "abc://page/cities/1?name=boston",
        "abc://page/cities/2?name=seattle",
        "abc://page/cities/3?name=chicago",
        "abc://page/cities/4?name=berkeley",
        "abc://page/cities/5?name=miami",
        "abc://page/cities/6?name=london",
